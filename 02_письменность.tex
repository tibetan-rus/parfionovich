...
2. Согласные, которые записываются первыми пятью корневыми графемами третьего ряда тибетского алфавита (\prfA{ག}, \prfA{ཇ}, \prfA{ད}, \prfA{བ}, \prfA{ཛ}), выступая в качестве второго слога в слове, озвончаются, например: \prfB{ཡི}{\mfa{ji}\toneV} + \prfB{གེ}{\mfa{k'e}\toneV} $\rightarrow$ \prfC{ཡི་གེ་}{\mfa{ji}\toneV\smallspace\mfa{ke}\toneR}{<<буква, письмена>>}.

3. В первом слоге слова приписная \prfA{ག} произносится \mfa{k}, например: \prfC{ངག་མ་}{\mfa{nak\toneV\smallspace{}ma\toneR}}{<<речь>>}.

4. Если \prfB{བ}{\mfa{p'a}\toneV}, \prfB{བེ}{\mfa{p'e}\toneV} или \prfB{བོ}{\mfa{p'o}\toneV} являются вторым слогом двуслога, то \mfa{р'} переходит в \mfa{w}, например: \prfB{གཏའ་བ་}{\mfa{ta}\toneR\smallspace\mfa{wa}\toneR}, \prfB{དཔའ་བོ་}{\mfa{pa}\toneR\smallspace\mfa{wo}\toneR}, \prfB{པེ་བེ་}{\mfa{pe}\toneR\smallspace\mfa{we}\toneR}, но \prfB{ནོན་བུ་}{\mfa{noñ}\toneV\smallspace\mfa{p'y}\toneR}.

5. Если слоги слова содержат гласные звуки \mfa{i} и \mfa{a} или \mfa{y} и \mfa{a}, то в составе слова происходит трансформация: \mfa{a} + \mfa{i} $\rightarrow$ \mfa{ɘ} + \mfa{i}; \mfa{i} + \mfa{a} $\rightarrow$ \mfa{i} + \mfa{ɘ}; \mfa{у} + \mfa{a} $\rightarrow$ \mfa{у} + \mfa{ɘ}; \mfa{a} + \mfa{у} $\rightarrow$ \mfa{ɘ} + \mfa{у}, например: \prfB{ཟི་མ་}{\mfa{si\toneV\smallspace{}mɘ\toneR}}, \prfB{མ་གི་}{\mfa{mɘ\toneV\smallspace{}ki\toneR}}, \prfB{ཁ་ཆུ་}{\mfa{k'ɘ\toneR\smallspace{}ts'u\toneR}}.
...
\prfB{ཟོར་བ་}{\mfa{so}\toneV\smallspace\mfa{ra}\toneR},
\prfB{ཡོལ་བ་}{\mfa{jö}\toneV\smallspace\mfa{la}\toneR},
\prfB{ཡོང་བ་}{\mfa{joŋ}\toneV\smallspace\mfa{ŋa}\toneR},
\prfB{ཐར་པ་}{\mfa{t'a}\toneR\smallspace\mfa{ra}\toneR}.
...
\prfB{ལྷོད་ལྷོད་}{\mfa{lhö}\toneR\smallspace\mfa{lo}\toneR}, \prfB{ཧྲང་ཧྲང་}{\mfa{šaŋ}\toneR\smallspace\mfa{raŋ}\toneR};
если надписных и подписных нет, а имеется приписная \prfA{བ} или \prfA{ག}, то во втором слоге она не произносится, например:
\prfB{ལེབ་ལེབ་}{\mfa{lep}\toneV\smallspace\mfa{le}\toneN},
\prfB{ཞིབ་ཞིབ་}{\mfa{sjip}\toneV\smallspace\mfa{sji}\smallspace\toneG\smallspace\toneN},
\prfB{རྡོག་རྡོག་}{\mfa{tok}\toneV\smallspace\mfa{to}\toneR}.
