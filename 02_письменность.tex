...
\begin{description}
	...
	\item {\unifont ⑦} --- надписные графемы \prfA{(མགོ་ཅན་)}, в качестве ко¬торых выступают корневые графемы \prfA{ར}, \prfA{ལ}, \prfA{ས}.
\end{description}
...
Каждая группа составляющих производного слога оказывает определенное влияние на его основу.
...
\begin{longtabu} to \linewidth {|X[1,c] X[1,c]|X[1,c] X[1,c]|X[1,c] X[1,c]|X[1,c] X[1,c]|}
	...
	Тибетские графемы & Транс\-ли\-те\-ра\-ция & Ти\-бет\-ские графемы & Транс\-ли\-те\-ра\-ция\\
